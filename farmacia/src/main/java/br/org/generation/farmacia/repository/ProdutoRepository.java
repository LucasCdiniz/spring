...
public interface ProdutoRepository extends JpaRepository<Produto,Long>{
	...
	public List <Produto> findAllByNomeContainingIgnoreCase(String nomeRemedio);

	
	public List<Produto> findByNomeAndLaboratorio(String nomeRemedio, String laboratorio);
